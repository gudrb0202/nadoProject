			...
			<section class="sidebar">
				...
				<ul class="sidebar-menu" data-widget="tree">
					...
					<li class="treeview"><a href="#"> <i
							class="fa fa-dashboard"></i> <span>전자결재</span> <span
							class="pull-right-container"> <i
								class="fa fa-angle-left pull-right"></i>
						</span>
					</a>
						<ul class="treeview-menu">
							<li class="active"><a href="electronicapproval/eaDraft.jsp"><i
									class="fa fa-circle-o"></i> 기안하기</a></li>
					...
					<li class="treeview"><a href="#"> <i class="fa fa-files-o"></i>
						...
						<ul class="treeview-menu">
							<li><a href="/test/views/layout/top-nav.html"><i
									class="fa fa-circle-o"></i> Top Navigation</a></li>
							<li><a href="/test/views/layout/boxed.html"><i
									class="fa fa-circle-o"></i> Boxed</a></li>
							<li><a href="/test/views/layout/fixed.html"><i
									class="fa fa-circle-o"></i> Fixed</a></li>
							<li><a href="/test/views/layout/collapsed-sidebar.html"><i
									class="fa fa-circle-o"></i> Collapsed Sidebar</a></li>
						</ul></li>
					<li><a href="/test/views/mailbox/mailbox.html"> <i
					...
					<li><a href="calendar/calendarMonthView.jsp"><i
							class="fa fa-calendar"></i> <span>캘린더</span></a></li>
					...
					<li><a href="https://adminlte.io/docs"><i
							class="fa fa-book"></i> <span>주소록</span></a></li>
					<li class="treeview"><a href="#"> <i class="fa fa-edit"></i>
							<span>예약</span> <span class="pull-right-container"> <i
								class="fa fa-angle-left pull-right"></i>
						</span>
					</a>
						<ul class="treeview-menu">
					...
					<li><a href="/test/views/widgets.html"> <i
							class="fa fa-th"></i> <span>전자메일</span> <span
							class="pull-right-container"> <small
					...
					<section class="col-lg-7 connectedSortable">
						...
						<div class="box box-success">
							...
							<div class="box-body chat" id="chat-box">
								<!-- chat item -->
								<div class="item">
									<img src="/nado/resources/groupware/dist/img/user4-128x128.jpg"
								...
								<!-- chat item -->
								<div class="item">
									<img src="/nado/resources/groupware/dist/img/user3-128x128.jpg"
